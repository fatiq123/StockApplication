...
import { FaPotato } from 'react-icons/fa6';
...
const MainMenu: React.FC = () => {
  ...
  return (
    <div style={{ 
        ...
        <Title style={{ marginBottom: '50px', fontSize: '2.5em', color: '#2c3e50', textAlign: 'center' }}>
        ...
        >
          <div style={{ marginTop: '10px' }}>Apple Storage</div>
        </Button>
        <Button 
          type="primary" 
          size="large"
          icon={<FaPotato style={{ fontSize: '32px' }} />}
        ...
        >
          <div style={{ marginTop: '10px' }}>Potato Storage</div>
        </Button>
      </Space>
    </div>
  );
